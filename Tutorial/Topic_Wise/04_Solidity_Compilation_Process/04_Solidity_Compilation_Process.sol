...
*) Some important points to note:
    ...
    -> Contrace doesn't have to be public.
    -> Bytecode in immutable.
    -> ABI act as bridge between applications and smart contract.
    -> ABI and Bytecode cannot be generated without source code.

*) Smart Contract Compilation
    *) ABI (Abstract binary interface)
        -> NOTE: this key is generated from the smart contract solidity programming .sol file
        -> [
        {
            "inputs": [],
            "name": "retrieve",
    ...
    *) Bytecode:
        -> https://etherscan.io/opcode-tool (bytecode to upcode)
            -> at the first of bytecode you have to put '0x' and only after the it will generate upcode
